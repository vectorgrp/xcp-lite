...
Proc-macro crate providing `#[derive(McRegisterType)]` and `#[derive(McRegisterEnum)]`.  
...
See the design specification in [`DESIGN.md`](DESIGN.md) and examples in the `examples` folder.  
