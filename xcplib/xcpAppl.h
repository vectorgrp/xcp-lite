...
extern void ApplXcpRegisterCallbacks(uint8_t (*cb_connect)(void),

                                     uint8_t (*cb_prepare_daq)(const tXcpDaqLists *daq), uint8_t (*cb_start_daq)(const tXcpDaqLists *daq), void (*cb_stop_daq)(void),
